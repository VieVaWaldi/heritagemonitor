...
// The real counterpart to modules/demo's SearchResultRow — kept as its own
// copy rather than shared, since this one is expected to diverge once it's
// wired to actual result data (e.g. linking the title to a detail page).
